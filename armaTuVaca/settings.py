"""
Django settings for armaTuVaca project.
...
SECRET_KEY = 'django-insecure-6erwymn7hcv)2s6ecmx*(bvz#^)6oxgu*r@8n&+pgx5pl3bje8'
...
WSGI_APPLICATION = 'armaTuVaca.wsgi.application'
